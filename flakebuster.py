#!/usr/bin/env python3
"""
Flakebuster — Evidence-based triage of Magento functional test failures in PR queues.

Usage:
    python flakebuster.py 2.4-develop
    python flakebuster.py 2.4-develop --channel C2MG0TNPL --bot W015DAXESG0
    python flakebuster.py 2.4-develop --output report.html
...
DEFAULT_OUTPUT     = "flakebuster-report.html"
...
<head>
  ...
  <title>Flakebuster Report — {html.escape(branch)}</title>
  <style>
...
<body>
  <div class="container">
    <header>
      <h1>🐛 Flakebuster Report — <code>{html.escape(branch)}</code></h1>
    ...
    <footer>Generated by Flakebuster · <a href="https://github.com/OneAdobe/flakebuster-agent" target="_blank">Inspired by flakebuster-agent</a></footer>
  </div>
</body>
</html>"""
...
# ──────────────────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="Flakebuster — Magento PR test failure analyzer")
